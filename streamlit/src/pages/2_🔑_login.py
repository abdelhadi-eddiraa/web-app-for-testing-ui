...
login_test_url = r'C:\Users\Destock\Desktop\frontend-integral\integral-tech-front-end-from-zero\py\streamlit\src\tests\loginTest.py'
...
with st.container():
    ...
    with left_column:
        ...
        st.button("Start Selenium login Test", type="primary",on_click=start_login_test)
